...
function Faqs() {
    // const requiremts = [
    //   {
    //     question: "What are the prerequisites to join Rebase Code Camp?",
    //     requirement1: "At least a GCE A-level certificate or equivalent qualification",
    //     requirement2: "Your personal computer (laptop)",
    //     requirement3: "Stable internet at home for home studies (the institution provides internet connection on campus.)",
    //   },
    //   {
    //     question: "What is the teaching approach at Rebase Code Camp?",
    //     answer: " Rebase Code Camp follows a hands-on and project-based learning approach. Students work on real-world projects to gain practical experience and develop their skills.",
    //     requirement1: "At least a GCE A-level certificate or equivalent qualification",
    //     requirement2: "Your personal computer (laptop)",
    //     requirement3: "Stable internet at home for home studies (the institution provides internet connection on campus.)",
    //   },
    //   {
    //     question: "What are the prerequisites to join Rebase Code Camp?",
    //     answer: "Rebase Code Camp does not provide certificates. However, we offer possibility for students to obtain internationally recognised certificates that can be a valuable addition to your resume and showcase your skills to potential employers.",
    //     requirement1: "At least a GCE A-level certificate or equivalent qualification",
    //     requirement2: "Your personal computer (laptop)",
    //     requirement3: "Stable internet at home for home studies (the institution provides internet connection on campus.)",
    //   },
    //   {
    //     question: "What are the prerequisites to join Rebase Code Camp?",
    //     answer: "Rebase Code Camp offers training in various programming languages, with main focus on MERN stack",
    //     requirement1: "At least a GCE A-level certificate or equivalent qualification",
    //     requirement2: "Your personal computer (laptop)",
    //     requirement3: "Stable internet at home for home studies (the institution provides internet connection on campus.)",
    //   }
