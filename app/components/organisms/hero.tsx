  ...
  return (
    <div className="relative mb-20 flex h-screen flex-col items-center mobile:max-md:h-full mobile:max-md:w-[100%]">
      ...
      <div className="absolute inset-0 top-40 px-6 text-white mobile:max-md:top-32  lg:mx-10 xl:top-32">
        ...
        <span
          className={` font-serif font-semi-bold  mb-4 w-3/5   font-serif text-7xl mobile:max-md:w-2/5 mobile:max-md:text-2xl ipad:text-4xl md:text-3xl lg:text-4xl  xl:text-7xl`}
        >
