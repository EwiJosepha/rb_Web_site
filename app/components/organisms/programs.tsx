...
function OurPrograms() {
  return (
    <div className="h-full-screen mt-5 bg-white  px-24 pt-20  mobile:max-md:pl-5 mobile:max-md:pr-5">
      <h1
      ...
      <div className="text-1xl flex justify-center  pb-10 align-middle ">
        <p className="p-3 text-center font-sans text-2xl text-gray-500 mobile:max-md:text-lg">
      ...
      <div className=" flex flex-col  gap-10 ">
        {programs.map((course, index) => (
          <div
            key={index}
            className=" flex max-w-full  items-center gap-20 mobile:max-md:flex-col mobile:max-md:gap-4"
          >
            <div className=" flex w-1/3 border-2 border-black  mobile:max-md:w-[100%] md:h-[100%]">
              <Image
                src={course.image}
                alt="program Image"
                className=" h-[280px] w-[100%] object-cover mobile:max-md:h-[295px]"
              />
            </div>
