...
const Testimonials: React.FC = () => {
    ...
    return (
        <div className="mb-14 mobile:max-md:mx-5 mobile:max-md:mr-[-9rem] lg:mx-36">
            <h1
                className={` mb-6 text-center text-6xl mobile:max-md:text-3xl`}
            >
                Testimonials
            </h1>
            <h3 className="mb-10 text-center font-sans text-xl">
                Hear what our students, former students and industry
                professionals have to say
            </h3>
            <div className="flex items-center justify-around">
                <button className=" left-7 -translate-y-1/2 transform rounded-full bg-orange-500 px-5 py-5 font-bold mobile:max-md:px-2 mobile:max-md:py-2">
                    <GrPrevious className=" previousbtn text-2xl text-white" />
                </button>

                <div className="grid w-[75%] grid-cols-2 gap-10 overflow-hidden">
                    {testifier.slice(0, 2).map((testimony, index) => (
                        <div
                            className="card bg-gray-200 p-10"
                            key={index}
                            style={{}}
                        >
                            ...
                            <h2 className="font-sans text-lg font-bold mobile:max-md:hidden">
                                {testimony.text}.
                            </h2>
